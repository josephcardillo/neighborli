...
transaction_list = [
  [1, 2, 'Open', DateTime.now, DateTime.now + 7.days, 'Borrow', true, false, 'Lawn', 'Lawnmower', 'Lightly used - good condition', 'Philadelphia', 7, 5],
  [2, 3, 'Closed', DateTime.now, DateTime.now + 3.days, 'Borrow', false, true, 'Kitchen', 'Mixer', 'Great for baking!', 'Haddonfield', 3, 2],
  [3, 1, 'Closed', DateTime.now, DateTime.now + 4.days, 'Lend', true, true, 'Electronics', 'DVD Player', 'Great for watching movies', 'Cherry Hill', 4, 3]
]
